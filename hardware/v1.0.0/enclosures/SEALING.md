...
| **Splash / dust** | Printed lids + gasket · lid LED clear insert + foam · KCD4 boot · C14 cover | Not certified whole-box IP67 |
...
| LED window (lid) | Clear printed insert + foam in recessed pocket · opaque dividers | splash/dust | — | Not an open slot — [`LED_WINDOW.md`](LED_WINDOW.md) |
...
5. LED = lid pocket + clear printed insert + foam. Lid = silicone gasket; hinges **internal** (bociloy 1" SS) — no external hinge cutouts.
