...
ELF="$FIRMWARE_DIR/target/thumbv6m-none-eabi/release/output-controller"
BIN="$ELF.bin"

echo "==> Building output-controller (release)..."
cd "$FIRMWARE_DIR"
...
echo ""
echo "==> DFU flash output-controller"
echo "    Connect USB-C to J7."
